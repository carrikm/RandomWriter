...
//
//  Uses hash mapping for faster lookup than the array and bst implementation
//
//   Command line inputs: resultfile NWordsToGenerate 
//
...
public class RandomWriterHash{
  public static void main (String[] args) throws IOException {
    ...
    HashMap<String, LinkedList<String>> hashTable = new HashMap<String,LinkedList<String>>();
    ...
    while(dataFile.hasNext()){
      ...
      if (hashTable.containsKey(current)){ //word found
        follows = hashTable.get(current);
